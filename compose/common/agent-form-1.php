        ...
        <?php if($entity->canUser("viewPrivateData")): ?>
            <?php if($this->isEditable() || $canSee('personalData')):?>
                ...
                <p class="privado">
                    ...
                    <span class="js-editable required js-mask-cpf <?php echo ($entity->isPropertyRequired($entity,"cpf") && $editEntity? 'required': '');?>" data-edit="cpf" data-original-title="<?php \MapasCulturais\i::esc_attr_e("CPF");?>" data-emptytext="<?php \MapasCulturais\i::esc_attr_e("Informe seu CPF  com pontos, hífens e barras");?>">
                        <?php echo $entity->cpf; ?>
                    </span>
                </p>
                  <!-- Campo Mei -->
