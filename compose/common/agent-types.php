...
return array(
    'metadata' => array(
        ...
        'raca' => array(
            ...
            'validations' => array(
                'required' => \MapasCulturais\i::__('Raça/cor deve ser informado.')
            ),
            'available_for_opportunities' => true
        ),
        ...
        'genero' => array(
            ...
            'validations' => array(
                'required' => \MapasCulturais\i::__('O gênero deve ser informado.')
            ),
            'available_for_opportunities' => true,
            'field_type' => 'select'
        ),
        ...
        'telefone1' => array(
            ...
            'type' => 'string',
            'validations' => array(
                'required' => \MapasCulturais\i::__('O número de telefone é obrigatório.'),
                'v::brPhone()' => \MapasCulturais\i::__('O número de telefone informado é inválido.')
            ),
            'available_for_opportunities' => true,
            'field_type' => 'brPhone'
