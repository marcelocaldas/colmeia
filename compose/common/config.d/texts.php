...
return [
    "text:home-header.title" => i::__("Boas-vindas ao Mapa Cultural do Pará"),
    "text:home-header.description" => i::__("O Mapa cultural do Pará é uma ferramenta de gestão cultural que garante a estruturação de Sistemas de Informações e Indicadores."),
    ...
    "text:home-feature.description" => i::__("Confira os últimos destaques de cada uma das área"),
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o Mapa cultural do Pará"),
