 ...
 */
    ...
    'items' => array(
       ...
       \MapasCulturais\i::__('Museus') => array(
        ...
        \MapasCulturais\i::__('Demais Equipamentos Ambientais') => array(
            'range' => array(100,199),
            'items' => array(
                100 => array( 'name' => \MapasCulturais\i::__('Área de Interesse Especial') ),
                101 => array( 'name' => \MapasCulturais\i::__('Área de Potencial Espeleológico' )),
                102 => array( 'name' => \MapasCulturais\i::__('Área de Preservação Permanente' )),
                103 => array( 'name' => \MapasCulturais\i::__('Área de Relevante Interesse Ecológico') ),
                104 => array( 'name' => \MapasCulturais\i::__('Área de Proteção Ambiental - APA' )),
                105 => array( 'name' => \MapasCulturais\i::__('Área Natural Tombada' )),
                106 => array( 'name' => \MapasCulturais\i::__('Área de Reserva Legal' )),
                107 => array( 'name' => \MapasCulturais\i::__('Centro de artesanato') ),
                108 => array( 'name' => \MapasCulturais\i::__('Casa de espetáculo' )),
                109 => array( 'name' => \MapasCulturais\i::__('Área Sob Proteção Especial - ASPE' )),
                110 => array( 'name' => \MapasCulturais\i::__('Aterro Sanitário' )),
                111 => array( 'name' => \MapasCulturais\i::__('Concha acústica' )),
                112 => array( 'name' => \MapasCulturais\i::__('Jardim Botânico' )),
                113 => array( 'name' => \MapasCulturais\i::__('Espaço para Eventos' )),
                114 => array( 'name' => \MapasCulturais\i::__('Horto' )),
                115 => array( 'name' => \MapasCulturais\i::__('Ponto de Leitura ' )),
                116 => array( 'name' => \MapasCulturais\i::__('Centro Comunitário' )),
                117 => array( 'name' => \MapasCulturais\i::__('Zoológico' )),
                125 => array( 'name' => \MapasCulturais\i::__('Ponto de Cultura' )),
                118 => array( 'name' => \MapasCulturais\i::__('Reserva extrativista' )),
                119 => array( 'name' => \MapasCulturais\i::__('Movimento ecológico') ),
                120 => array( 'name' => \MapasCulturais\i::__('Orgão Público' )),
                121 => array( 'name' => \MapasCulturais\i::__('ONG-Organização não governamental' )),
                122 => array( 'name' => \MapasCulturais\i::__('OSCIP - Organização Social de Interesse Público' )),
                123 => array( 'name' => \MapasCulturais\i::__('Reserva biológica' )),
                126 => array( 'name' => \MapasCulturais\i::__('Associação' )),
                127 => array( 'name' => \MapasCulturais\i::__('Sindicato' )),
                ...
                124 => array( 'name' => \MapasCulturais\i::__('Reserva ecológica' )),
                131 => array( 'name' => \MapasCulturais\i::__('Parque Nacional' )),
                132 => array( 'name' => \MapasCulturais\i::__('Grupo de Pesquisa' )),
                133 => array( 'name' => \MapasCulturais\i::__('Diretório Acadêmico' )),
                134 => array( 'name' => \MapasCulturais\i::__('Ginásio Poliesportivo') ),
                135 => array( 'name' => \MapasCulturais\i::__('Sala de Leitura' )),
                136 => array( 'name' => \MapasCulturais\i::__('Grêmio estudantil' )),
                137 => array( 'name' => \MapasCulturais\i::__('Núcleos de Produção Digital' )),

                199 => array( 'name' => \MapasCulturais\i::__('Outros Equipamentos Ambientais' )), // adicionado na importação dos dados do Ceará para receber as endidades do tipo "equipamento"
            )
        ),
