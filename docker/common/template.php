...
<div class="home-entities">
    ...
    <div class="home-entities__content">
        <div class="home-entities__content--header">
            <label class="title">
                <?= $this->text('title', i::__('Aqui você encontra as informações do meio ambiente de sua região!')) ?>
            </label>
        ...
        <div class="home-entities__content--cards">
            ...
            <div v-if="global.enabledEntities.events" class="card">
                ...
                <div class="card__right">
                    <p><?= $this->text('events', i::__('Você pode pesquisar eventos e ações ambientais nos campos de busca combinada. Como usuário cadastrado, você pode incluir seus eventos na plataforma e divulgá-los gratuitamente. (Mais uma linha aqui pra fechar cinco linhas)')) ?></p>
            ...
            <div v-if="global.enabledEntities.spaces" class="card">
                ...
                <div class="card__right">
                    <p><?= $this->text('spaces', i::__('Procure por espaços ambientais incluídos na plataforma, acessando os campos de busca combinada que ajudam na precisão de sua pesquisa. Cadastre também os espaços onde desenvolve suas atividades em defesa do meio ambiente.')) ?></p>
            ...
            <div v-if="global.enabledEntities.agents" class="card">
                ...
                <div class="card__right">
                    <p><?= $this->text('agents', i::__('Neste espaço, estão registrados ativistas, gestores e produtores; uma rede de atores envolvidos na luta ambiental. Você pode cadastrar um ou mais agentes (grupos, coletivos, bandas instituições, empresas, etc.), (...)')) ?></p>
            ...
            <div v-if="global.enabledEntities.projects" class="card">
                ...
                <div class="card__right">
                    <p><?= $this->text('projects', i::__('Aqui você encontra eventos, mostras, convocatórias e editais criados, além de diversas iniciativas cadastradas pelos usuários da plataforma.')) ?></p>
